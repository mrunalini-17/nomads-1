        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- Head --}}
                    <div class="py-3 px-2">
                        <h3 class="font-weight-bold text-primary">Approved Bookings List</h3>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="newdataTable" cellspacing="0" style="font-size: 14px;">
                                    ...
                                    <tbody id="booking-table-body">
                                        @include('homecontent.booking.partials.approved_booking_table', ['bookings' => $bookings])
                                    </tbody>
                                </table>
    ...
    <script>
        $(document).ready(function () {
            $('#booking-search').on('input', function () {
                ...
                $.ajax({
                    url: "{{ route('bookings.approved_index') }}",
                    method: 'GET',
