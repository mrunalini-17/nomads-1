                                ...
                                <form action="{{ route('cards.update', $card->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="card_name"
                                            name="card_name" value="{{ $card->name }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="card_number" class="form-label">Card Number</label>
                                        <input type="number" class="form-control" id="card_number"
                                            name="card_number" value="{{ $card->number }}" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="comment" name="comment">{{$card->comment}}</textarea>
                                    </div>
